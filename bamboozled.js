...
const languageString = {
    'en': {
        'translation': {
            ...
            'GAME_NAME': 'Bamboozled', // Be sure to change this for your skill.
...
const newSessionHandlers = {
    ...
    'AMAZON.StartGameIntent': function () {
        this.handler.state = GAME_STATES.START;
        this.emitWithState('StartGame', true);
    },
...
function handleUserGuess(userGaveUp) {
    ...
    const currentPlayer = parseInt(this.attributes.currentPlayer, 10);
    let speechOutput = '';
    let speechOutputAnalysis = '';
    const gameQuestions = this.attributes.questions;
    let correctAnswerIndex = parseInt(this.attributes.correctAnswerIndex, 10);
    let currentScore = parseInt(this.attributes.scores[currentPlayer], 10);
    ...
    if (this.attributes['currentQuestionIndex'] === GAME_LENGTH - 1) {
        ...
        speechOutput += `Now question for player ${currentPlayer}`;
        ...
        this.attributes.scores[currentPlayer] = currentScore;
...
const startStateHandlers = Alexa.CreateStateHandler(GAME_STATES.START, {
    'StartGame': function (newGame) {
        ...
        speechOutput += `Player ${currentPlayer} `;
